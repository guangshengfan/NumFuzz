...
if ! [ $(command llvm-config --version) = "6.0.1" ]; then
    ...
    ${ROOT_DIR}/../../tool/AFL-2.52b/build/bin/afl-clang-fast -O0 legendreQ0.c -o legendreQ0 -lgsl -lgslcblas -lm
    ...
    ${ROOT_DIR}/../../tool/AFL-2.52b/build/bin/afl-fuzz -i ${ROOT_DIR}/specfunc/gsl_sf_legendre_Q0/in -o ${ROOT_DIR}/specfunc/gsl_sf_legendre_Q0/out_AFL$i -m none -d -t 5000 -- ${ROOT_DIR}/specfunc/gsl_sf_legendre_Q0/legendreQ0 @@
fi
