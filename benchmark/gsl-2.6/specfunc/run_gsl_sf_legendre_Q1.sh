...
if ! [ $(command llvm-config --version) = "6.0.1" ]; then
    ...
    ${ROOT_DIR}/../../tool/AFL-2.52b/build/bin/afl-clang-fast legendre_Q1.c -o legendre_Q1 -fsanitize=address -lgsl -lgslcblas -lm
    ...
    ${ROOT_DIR}/../../tool/AFL-2.52b/build/bin/afl-fuzz -i ${ROOT_DIR}/specfunc/gsl_sf_legendre_Q1/in -o ${ROOT_DIR}/specfunc/gsl_sf_legendre_Q1/out_AFL$i -m none -d -t 5000 -- ${ROOT_DIR}/specfunc/gsl_sf_legendre_Q1/legendre_Q1 @@
fi
