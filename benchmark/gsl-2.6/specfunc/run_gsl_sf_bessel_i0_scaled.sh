...
if ! [ $(command llvm-config --version) = "6.0.1" ]; then
    ...
    ${ROOT_DIR}/../../tool/AFL-2.52b/build/bin/afl-fuzz -i ${ROOT_DIR}/specfunc/gsl_sf_bessel_i0_scaled/in -o ${ROOT_DIR}/specfunc/gsl_sf_bessel_i0_scaled/out_AFL$i -m none -d -t 5000 -- ${ROOT_DIR}/specfunc/gsl_sf_bessel_i0_scaled/i0scaled @@
fi
