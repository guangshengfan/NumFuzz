...
if ! [ $(command llvm-config --version) = "6.0.1" ]; then
    ...
    ${ROOT_DIR}/../../tool/AFL-2.52b/build/bin/afl-fuzz -i ${ROOT_DIR}/specfunc/gsl_sf_bessel_y0/in -o ${ROOT_DIR}/specfunc/gsl_sf_bessel_y0/out_AFL$i -m none -t 5000 -- ${ROOT_DIR}/specfunc/gsl_sf_bessel_y0/bessely0 @@
fi
