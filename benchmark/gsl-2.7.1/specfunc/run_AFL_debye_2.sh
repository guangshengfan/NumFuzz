...
#    ${ROOT_DIR}/../../tool/AFL-2.52b/build/bin/afl-clang-fast debye_2.c -o debye_2 -lm -lgsl -lgslcblas
    ...
    ${ROOT_DIR}/../../tool/AFL/build/bin/afl-fuzz -i ${ROOT_DIR}/specfunc/gsl_sf_debye_2/in -o ${ROOT_DIR}/specfunc/gsl_sf_debye_2/out_AFL$i -m none -t 5000 -- ${ROOT_DIR}/specfunc/gsl_sf_debye_2/debye_2 @@
fi
