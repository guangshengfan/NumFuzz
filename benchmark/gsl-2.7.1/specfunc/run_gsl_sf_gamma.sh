...
if ! [ $(command llvm-config --version) = "6.0.1" ]; then
    ...
    ${ROOT_DIR}/../../tool/AFL-2.52b/build/bin/afl-clang-fast gamma.c -o gamma -g -O0  -lm -lgsl -lgslcblas
    ...
    ${ROOT_DIR}/../../tool/AFL-2.52b/build/bin/afl-fuzz -i ${ROOT_DIR}/specfunc/gsl_sf_gamma/in -o ${ROOT_DIR}/specfunc/gsl_sf_gamma/out_AFL$i -m none -t 5000 -- ${ROOT_DIR}/specfunc/gsl_sf_gamma/gamma @@
fi
