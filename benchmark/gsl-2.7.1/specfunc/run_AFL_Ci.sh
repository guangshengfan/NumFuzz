...
#    ${ROOT_DIR}/../../tool/AFL-2.52b/build/bin/afl-clang-fast Ci.c -o Ci -lm -lgsl -lgslcblas
    ...
    ${ROOT_DIR}/../../tool/AFL/build/bin/afl-fuzz -i ${ROOT_DIR}/specfunc/gsl_sf_Ci/in -o ${ROOT_DIR}/specfunc/gsl_sf_Ci/out_AFL$i -m none -t 5000 -- ${ROOT_DIR}/specfunc/gsl_sf_Ci/Ci @@
fi
