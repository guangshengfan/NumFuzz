...
#    ${ROOT_DIR}/../../tool/AFL-2.52b/build/bin/afl-clang-fast expint_E2.c -o expint_E2 -lm -lgsl -lgslcblas
    ...
    ${ROOT_DIR}/../../tool/AFL/build/bin/afl-fuzz -i ${ROOT_DIR}/specfunc/gsl_sf_expint_E2/in -o ${ROOT_DIR}/specfunc/gsl_sf_expint_E2/out_AFL$i -m none -t 5000 -- ${ROOT_DIR}/specfunc/gsl_sf_expint_E2/expint_E2 @@
fi
