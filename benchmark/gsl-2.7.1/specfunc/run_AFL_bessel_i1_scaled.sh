...
#    ${ROOT_DIR}/../../tool/AFL-2.52b/build/bin/afl-clang-fast i1scaled.c -o i1scaled -lm -lgsl -lgslcblas
    ...
    ${ROOT_DIR}/../../tool/AFL/build/bin/afl-fuzz -i ${ROOT_DIR}/specfunc/gsl_sf_bessel_i1_scaled/in -o ${ROOT_DIR}/specfunc/gsl_sf_bessel_i1_scaled/out_AFL$i -m none -t 5000 -- ${ROOT_DIR}/specfunc/gsl_sf_bessel_i1_scaled/i1scaled @@
fi
