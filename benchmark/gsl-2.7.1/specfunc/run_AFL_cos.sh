...
#    ${ROOT_DIR}/../../tool/AFL-2.52b/build/bin/afl-clang-fast cos.c -o cos -lm -lgsl -lgslcblas
    ...
    ${ROOT_DIR}/../../tool/AFL/build/bin/afl-fuzz -i ${ROOT_DIR}/specfunc/gsl_sf_cos/in -o ${ROOT_DIR}/specfunc/gsl_sf_cos/out_AFL$i -m none -t 5000 -- ${ROOT_DIR}/specfunc/gsl_sf_cos/cos @@
fi
