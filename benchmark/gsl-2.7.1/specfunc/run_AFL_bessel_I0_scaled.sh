...
#    ${ROOT_DIR}/../../tool/AFL-2.52b/build/bin/afl-clang-fast bessel_I0_scaled.c -o bessel_I0_scaled -Wl,-rpath=/usr/local/lib -lm -lgsl -lgslcblas
    ...
    ${ROOT_DIR}/../../tool/AFL/build/bin/afl-fuzz -i ${ROOT_DIR}/specfunc/gsl_sf_bessel_I0_scaled/in -o ${ROOT_DIR}/specfunc/gsl_sf_bessel_I0_scaled/out_AFL$i -m none -t 5000 -- ${ROOT_DIR}/specfunc/gsl_sf_bessel_I0_scaled/bessel_I0_scaled @@
fi
