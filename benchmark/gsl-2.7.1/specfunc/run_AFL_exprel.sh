...
#    ${ROOT_DIR}/../../tool/AFL-2.52b/build/bin/afl-clang-fast exprel.c -o exprel -lm -lgsl -lgslcblas
    ...
    ${ROOT_DIR}/../../tool/AFL/build/bin/afl-fuzz -i ${ROOT_DIR}/specfunc/gsl_sf_exprel/in -o ${ROOT_DIR}/specfunc/gsl_sf_exprel/out_AFL$i -m none -t 5000 -- ${ROOT_DIR}/specfunc/gsl_sf_exprel/exprel @@
fi
