...
#    ${ROOT_DIR}/../../tool/AFL-2.52b/build/bin/afl-clang-fast expint_Ei_scaled.c -o expint_Ei_scaled -lm -lgsl -lgslcblas
    ...
    ${ROOT_DIR}/../../tool/AFL/build/bin/afl-fuzz -i ${ROOT_DIR}/specfunc/gsl_sf_expint_Ei_scaled/in -o ${ROOT_DIR}/specfunc/gsl_sf_expint_Ei_scaled/out_AFL$i -m none -t 5000 -- ${ROOT_DIR}/specfunc/gsl_sf_expint_Ei_scaled/expint_Ei_scaled @@
fi
