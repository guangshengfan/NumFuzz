...
#    ${ROOT_DIR}/../../tool/AFL-2.52b/build/bin/afl-clang-fast expintE2scaled.c -o expintE2scaled -lm -lgsl -lgslcblas
    ...
    ${ROOT_DIR}/../../tool/AFL/build/bin/afl-fuzz -i ${ROOT_DIR}/specfunc/gsl_sf_expint_E2_scaled/in -o ${ROOT_DIR}/specfunc/gsl_sf_expint_E2_scaled/out_AFL$i -m none -t 5000 -- ${ROOT_DIR}/specfunc/gsl_sf_expint_E2_scaled/expintE2scaled @@
fi
