...
#    ${ROOT_DIR}/../../tool/AFL-2.52b/build/bin/afl-clang-fast logerfc.c -o logerfc -lm -lgsl -lgslcblas
    ...
    ${ROOT_DIR}/../../tool/AFL/build/bin/afl-fuzz -i ${ROOT_DIR}/specfunc/gsl_sf_log_erfc/in -o ${ROOT_DIR}/specfunc/gsl_sf_log_erfc/out_AFL$i -m none -t 5000 -- ${ROOT_DIR}/specfunc/gsl_sf_log_erfc/logerfc @@
fi
