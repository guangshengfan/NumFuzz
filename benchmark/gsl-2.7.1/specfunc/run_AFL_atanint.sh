...
#    ${ROOT_DIR}/../../tool/AFL-2.52b/build/bin/afl-clang-fast -Wl,-rpath=/usr/local/lib -lgsl -lgslcblas -lm atanint.c -o atanint 
    ...
    ${ROOT_DIR}/../../tool/AFL/build/bin/afl-fuzz -i ${ROOT_DIR}/specfunc/gsl_sf_atanint/in -o ${ROOT_DIR}/specfunc/gsl_sf_atanint/out_AFL$i -m none -t 5000 -- ${ROOT_DIR}/specfunc/gsl_sf_atanint/atanint @@
fi
