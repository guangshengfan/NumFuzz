...
#    ${ROOT_DIR}/../../tool/AFL-2.52b/build/bin/afl-clang-fast exprel2.c -o exprel2 -lm -lgsl -lgslcblas
    ...
    ${ROOT_DIR}/../../tool/AFL/build/bin/afl-fuzz -i ${ROOT_DIR}/specfunc/gsl_sf_exprel_2/in -o ${ROOT_DIR}/specfunc/gsl_sf_exprel_2/out_AFL$i -m none -t 5000 -- ${ROOT_DIR}/specfunc/gsl_sf_exprel_2/exprel2 @@
fi
