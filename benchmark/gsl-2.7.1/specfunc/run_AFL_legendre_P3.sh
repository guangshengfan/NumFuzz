...
#    ${ROOT_DIR}/../../tool/AFL-2.52b/build/bin/afl-clang-fast legendreP3.c -o legendreP3 -lm -lgsl -lgslcblas
    ...
    ${ROOT_DIR}/../../tool/AFL/build/bin/afl-fuzz -i ${ROOT_DIR}/specfunc/gsl_sf_legendre_P3/in -o ${ROOT_DIR}/specfunc/gsl_sf_legendre_P3/out_AFL$i -m none -t 5000 -- ${ROOT_DIR}/specfunc/gsl_sf_legendre_P3/legendreP3 @@
fi
