...
#    ${ROOT_DIR}/../../tool/AFL-2.52b/build/bin/afl-clang-fast expint_Ei.c -o expint_Ei -lm -lgsl -lgslcblas
    ...
    ${ROOT_DIR}/../../tool/AFL/build/bin/afl-fuzz -i ${ROOT_DIR}/specfunc/gsl_sf_expint_Ei/in -o ${ROOT_DIR}/specfunc/gsl_sf_expint_Ei/out_AFL$i -m none  -t 5000 -- ${ROOT_DIR}/specfunc/gsl_sf_expint_Ei/expint_Ei @@
fi
