...
#    ${ROOT_DIR}/../../tool/AFL-2.52b/build/bin/afl-clang-fast lambert_Wm1.c -o lambert_Wm1 -fsanitize=address -lm -lgsl -lgslcblas
    ...
    ${ROOT_DIR}/../../tool/AFL/build/bin/afl-fuzz -i ${ROOT_DIR}/specfunc/gsl_sf_lambert_Wm1/in -o ${ROOT_DIR}/specfunc/gsl_sf_lambert_Wm1/out_AFL$i -m none -t 5000 -- ${ROOT_DIR}/specfunc/gsl_sf_lambert_Wm1/lambert_Wm1 @@
fi
