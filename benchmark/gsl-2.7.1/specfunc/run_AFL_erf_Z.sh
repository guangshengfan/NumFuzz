...
#    ${ROOT_DIR}/../../tool/AFL-2.52b/build/bin/afl-clang-fast erf_Z.c -o erf_Z -lm -lgsl -lgslcblas
    ...
    ${ROOT_DIR}/../../tool/AFL/build/bin/afl-fuzz -i ${ROOT_DIR}/specfunc/gsl_sf_erf_Z/in -o ${ROOT_DIR}/specfunc/gsl_sf_erf_Z/out_AFL$i -m none -t 5000 -- ${ROOT_DIR}/specfunc/gsl_sf_erf_Z/erf_Z @@
fi
