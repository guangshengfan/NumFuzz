...
#    ${ROOT_DIR}/../../tool/AFL-2.52b/build/bin/afl-clang-fast bessel_j2.c -o bessel_j2 -Wl,-rpath=/usr/local/lib -lm -lgsl -lgslcblas
    ...
    ${ROOT_DIR}/../../tool/AFL/build/bin/afl-fuzz -i ${ROOT_DIR}/specfunc/gsl_sf_bessel_j2/in -o ${ROOT_DIR}/specfunc/gsl_sf_bessel_j2/out_AFL$i -m none -t 5000 -- ${ROOT_DIR}/specfunc/gsl_sf_bessel_j2/bessel_j2 @@
fi
