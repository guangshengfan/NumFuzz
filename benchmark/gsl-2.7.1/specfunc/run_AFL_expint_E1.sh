...
#    ${ROOT_DIR}/../../tool/AFL-2.52b/build/bin/afl-clang-fast expint_E1.c -o expint_E1 -lm -lgsl -lgslcblas
    ...
    ${ROOT_DIR}/../../tool/AFL/build/bin/afl-fuzz -i ${ROOT_DIR}/specfunc/gsl_sf_expint_E1/in -o ${ROOT_DIR}/specfunc/gsl_sf_expint_E1/out_AFL$i -m none -t 5000 -- ${ROOT_DIR}/specfunc/gsl_sf_expint_E1/expint_E1 @@
fi
