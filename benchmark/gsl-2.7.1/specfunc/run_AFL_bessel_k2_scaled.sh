...
#    ${ROOT_DIR}/../../tool/AFL-2.52b/build/bin/afl-clang-fast bessel_k2_scaled.c -o bessel_k2_scaled -Wl,-rpath=/usr/local/lib -lm -lgsl -lgslcblas
    ...
    ${ROOT_DIR}/../../tool/AFL/build/bin/afl-fuzz -i ${ROOT_DIR}/specfunc/gsl_sf_bessel_k2_scaled/in -o ${ROOT_DIR}/specfunc/gsl_sf_bessel_k2_scaled/out_AFL$i -m none -t 5000 -- ${ROOT_DIR}/specfunc/gsl_sf_bessel_k2_scaled/bessel_k2_scaled @@
fi
