...
#    ${ROOT_DIR}/../../tool/AFL-2.52b/build/bin/afl-clang-fast airy_Bi.c -o airy_Bi -lm -lgsl -lgslcblas
    ...
    ${ROOT_DIR}/../../tool/AFL/build/bin/afl-fuzz -i ${ROOT_DIR}/specfunc/gsl_sf_airy_Bi/in -o ${ROOT_DIR}/specfunc/gsl_sf_airy_Bi/out_AFL$i -m none -t 5000 -- ${ROOT_DIR}/specfunc/gsl_sf_airy_Bi/airy_Bi @@
fi
