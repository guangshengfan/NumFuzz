...
#    ${ROOT_DIR}/../../tool/AFL-2.52b/build/bin/afl-clang-fast dilog.c -o dilog -lm -lgsl -lgslcblas
    ...
    ${ROOT_DIR}/../../tool/AFL/build/bin/afl-fuzz -i ${ROOT_DIR}/specfunc/gsl_sf_dilog/in -o ${ROOT_DIR}/specfunc/gsl_sf_dilog/out_AFL$i -m none -t 5000 -- ${ROOT_DIR}/specfunc/gsl_sf_dilog/dilog @@
fi
