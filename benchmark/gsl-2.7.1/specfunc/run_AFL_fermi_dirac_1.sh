...
#    ${ROOT_DIR}/../../tool/AFL-2.52b/build/bin/afl-clang-fast fermi_dirac_1.c -o fermi_dirac_1 -fsanitize=address -lm -lgsl -lgslcblas
    ...
    ${ROOT_DIR}/../../tool/AFL/build/bin/afl-fuzz -i ${ROOT_DIR}/specfunc/gsl_sf_fermi_dirac_1/in -o ${ROOT_DIR}/specfunc/gsl_sf_fermi_dirac_1/out_AFL$i -m none -t 5000 -- ${ROOT_DIR}/specfunc/gsl_sf_fermi_dirac_1/fermi_dirac_1 @@
fi
