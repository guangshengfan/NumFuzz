...
#    ${ROOT_DIR}/../../tool/AFL-2.52b/build/bin/afl-clang-fast fermi_dirac_half.c -o fermi_dirac_half -lm -lgsl -lgslcblas
    ...
    ${ROOT_DIR}/../../tool/AFL/build/bin/afl-fuzz -i ${ROOT_DIR}/specfunc/gsl_sf_fermi_dirac_half/in -o ${ROOT_DIR}/specfunc/gsl_sf_fermi_dirac_half/out_AFL$i -m none -t 5000 -- ${ROOT_DIR}/specfunc/gsl_sf_fermi_dirac_half/fermi_dirac_half @@
fi
