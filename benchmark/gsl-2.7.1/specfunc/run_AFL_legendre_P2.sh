...
#    ${ROOT_DIR}/../../tool/AFL-2.52b/build/bin/afl-clang-fast legendreP2.c -o legendreP2 -lm -lgsl -lgslcblas
    ...
    ${ROOT_DIR}/../../tool/AFL/build/bin/afl-fuzz -i ${ROOT_DIR}/specfunc/gsl_sf_legendre_P2/in -o ${ROOT_DIR}/specfunc/gsl_sf_legendre_P2/out_AFL$i -m none -t 5000 -- ${ROOT_DIR}/specfunc/gsl_sf_legendre_P2/legendreP2 @@
fi
