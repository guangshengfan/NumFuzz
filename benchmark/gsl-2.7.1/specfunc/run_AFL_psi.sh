...
#    ${ROOT_DIR}/../../tool/AFL-2.52b/build/bin/afl-clang-fast psi.c -o psi -lm -lgsl -lgslcblas
    ...
    ${ROOT_DIR}/../../tool/AFL/build/bin/afl-fuzz -i ${ROOT_DIR}/specfunc/gsl_sf_psi/in -o ${ROOT_DIR}/specfunc/gsl_sf_psi/out_AFL$i -m none -t 5000 -- ${ROOT_DIR}/specfunc/gsl_sf_psi/psi @@
fi
