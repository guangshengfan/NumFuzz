...
if ! [ $(command llvm-config --version) = "6.0.1" ]; then
    ...
    ${ROOT_DIR}/../../tool/AFL-2.52b/build/bin/afl-clang-fast airy_Bi_scaled.c -o airy_Bi_scaled -lm -lgsl -lgslcblas
    ...
    ${ROOT_DIR}/../../tool/AFL-2.52b/build/bin/afl-fuzz -i ${ROOT_DIR}/specfunc/gsl_sf_airy_Bi_scaled/in -o ${ROOT_DIR}/specfunc/gsl_sf_airy_Bi_scaled/out_AFL$i -m none -t 5000 -- ${ROOT_DIR}/specfunc/gsl_sf_airy_Bi_scaled/airy_Bi_scaled @@
fi
