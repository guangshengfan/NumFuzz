...
#    ${ROOT_DIR}/../../tool/AFL-2.52b/build/bin/afl-clang-fast bessel_j1.c -o bessel_j1 -Wl,-rpath=/usr/local/lib -lm -lgsl -lgslcblas
    ...
    ${ROOT_DIR}/../../tool/AFL/build/bin/afl-fuzz -i ${ROOT_DIR}/specfunc/gsl_sf_bessel_j1/in -o ${ROOT_DIR}/specfunc/gsl_sf_bessel_j1/out_AFL$i -m none -t 5000 -- ${ROOT_DIR}/specfunc/gsl_sf_bessel_j1/bessel_j1 @@
fi
