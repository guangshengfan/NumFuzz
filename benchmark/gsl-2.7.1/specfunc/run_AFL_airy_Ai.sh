...
#${ROOT_DIR}/../../tool/AFL/build/bin/afl-clang-fast airy_Ai.c -o airy_Ai -lm -lgsl -lgslcblas
...
#    echo 3.92566322508156018145 > in/testcase7
    ...
    ${ROOT_DIR}/../../tool/AFL/build/bin/afl-fuzz -i ${ROOT_DIR}/specfunc/gsl_sf_airy_Ai/in -o ${ROOT_DIR}/specfunc/gsl_sf_airy_Ai/out_AFL$i -m none -t 5000 -- ${ROOT_DIR}/specfunc/gsl_sf_airy_Ai/airy_Ai @@
fi
