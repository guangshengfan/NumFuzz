...
if ! [ $(command llvm-config --version) = "6.0.1" ]; then
    ...
    ${ROOT_DIR}/../../tool/AFL-2.52b/build/bin/afl-fuzz -i ${ROOT_DIR}/specfunc/gsl_sf_airy_Ai_deriv_scaled/in -o ${ROOT_DIR}/specfunc/gsl_sf_airy_Ai_deriv_scaled/out_AFL$i -m none -t 5000 -- ${ROOT_DIR}/specfunc/gsl_sf_airy_Ai_deriv_scaled/airy_Ai_deriv_scaled @@
fi
