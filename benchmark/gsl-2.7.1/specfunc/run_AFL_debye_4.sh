...
#    ${ROOT_DIR}/../../tool/AFL-2.52b/build/bin/afl-clang-fast debye_4.c -o debye_4 -lm -lgsl -lgslcblas
    ...
    ${ROOT_DIR}/../../tool/AFL/build/bin/afl-fuzz -i ${ROOT_DIR}/specfunc/gsl_sf_debye_4/in -o ${ROOT_DIR}/specfunc/gsl_sf_debye_4/out_AFL$i -m none -t 5000 -- ${ROOT_DIR}/specfunc/gsl_sf_debye_4/debye_4 @@
fi
