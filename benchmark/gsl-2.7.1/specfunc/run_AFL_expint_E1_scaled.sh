...
#    ${ROOT_DIR}/../../tool/AFL-2.52b/build/bin/afl-clang-fast expint_E1_scaled.c -o expint_E1_scaled -lm -lgsl -lgslcblas
    ...
    ${ROOT_DIR}/../../tool/AFL/build/bin/afl-fuzz -i ${ROOT_DIR}/specfunc/gsl_sf_expint_E1_scaled/in -o ${ROOT_DIR}/specfunc/gsl_sf_expint_E1_scaled/out_AFL$i -m none -t 5000 -- ${ROOT_DIR}/specfunc/gsl_sf_expint_E1_scaled/expint_E1_scaled @@
fi
