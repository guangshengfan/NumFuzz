...
if ! [ $(command llvm-config --version) = "6.0.1" ]; then
    ...
    ${ROOT_DIR}/../../tool/AFL-2.52b/build/bin/afl-clang-fast bessely1.c -o bessely1 -lm -lgsl -lgslcblas
    ...
    ${ROOT_DIR}/../../tool/AFL-2.52b/build/bin/afl-fuzz -i ${ROOT_DIR}/specfunc/gsl_sf_bessel_y1/in -o ${ROOT_DIR}/specfunc/gsl_sf_bessel_y1/out_NUMFUZZE$i -m none -t 5000 -- ${ROOT_DIR}/specfunc/gsl_sf_bessel_y1/bessely1 @@
fi
