...
#    ${ROOT_DIR}/../../tool/AFL-2.52b/build/bin/afl-clang-fast erfQ.c -o erfQ -lm -lgsl -lgslcblas
    ...
    ${ROOT_DIR}/../../tool/AFL/build/bin/afl-fuzz -i ${ROOT_DIR}/specfunc/gsl_sf_erf_Q/in -o ${ROOT_DIR}/specfunc/gsl_sf_erf_Q/out_AFL$i -m none -t 5000 -- ${ROOT_DIR}/specfunc/gsl_sf_erf_Q/erfQ @@
fi
