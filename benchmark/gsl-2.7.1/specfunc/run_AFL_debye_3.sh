...
#    ${ROOT_DIR}/../../tool/AFL-2.52b/build/bin/afl-clang-fast debye_3.c -o debye_3 -lm -lgsl -lgslcblas
    ...
    ${ROOT_DIR}/../../tool/AFL/build/bin/afl-fuzz -i ${ROOT_DIR}/specfunc/gsl_sf_debye_3/in -o ${ROOT_DIR}/specfunc/gsl_sf_debye_3/out_AFL$i -m none -t 5000 -- ${ROOT_DIR}/specfunc/gsl_sf_debye_3/debye_3 @@
fi
