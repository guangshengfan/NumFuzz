...
#    ${ROOT_DIR}/../../tool/AFL-2.52b/build/bin/afl-clang-fast gammastar.c -o gammastar -lm -lgsl -lgslcblas
    ...
    ${ROOT_DIR}/../../tool/AFL/build/bin/afl-fuzz -i ${ROOT_DIR}/specfunc/gsl_sf_gammastar/in -o ${ROOT_DIR}/specfunc/gsl_sf_gammastar/out_AFL$i -m none -t 5000 -- ${ROOT_DIR}/specfunc/gsl_sf_gammastar/gammastar @@
fi
