...
#    ${ROOT_DIR}/../../tool/AFL-2.52b/build/bin/afl-clang-fast lambert_W0.c -o lambert_W0 -lm -lgsl -lgslcblas
    ...
    ${ROOT_DIR}/../../tool/AFL/build/bin/afl-fuzz -i ${ROOT_DIR}/specfunc/gsl_sf_lambert_W0/in -o ${ROOT_DIR}/specfunc/gsl_sf_lambert_W0/out_AFL$i -m none -t 5000 -- ${ROOT_DIR}/specfunc/gsl_sf_lambert_W0/lambert_W0 @@
fi
