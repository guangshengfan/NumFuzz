...
#    ${ROOT_DIR}/../../tool/AFL-2.52b/build/bin/afl-clang-fast airy_Ai_deriv.c -o airy_Ai_deriv -lm -lgsl -lgslcblas
    ...
    ${ROOT_DIR}/../../tool/AFL/build/bin/afl-fuzz -i ${ROOT_DIR}/specfunc/gsl_sf_airy_Ai_deriv/in -o ${ROOT_DIR}/specfunc/gsl_sf_airy_Ai_deriv/out_AFL$i -m none -t 5000 -- ${ROOT_DIR}/specfunc/gsl_sf_airy_Ai_deriv/airy_Ai_deriv @@
fi
