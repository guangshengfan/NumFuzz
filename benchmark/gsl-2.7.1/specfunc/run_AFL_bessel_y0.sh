...
#    ${ROOT_DIR}/../../tool/AFL-2.52b/build/bin/afl-clang-fast bessely0.c -o bessely0 -lm -lgsl -lgslcblas
    ...
    ${ROOT_DIR}/../../tool/AFL/build/bin/afl-fuzz -i ${ROOT_DIR}/specfunc/gsl_sf_bessel_y0/in -o ${ROOT_DIR}/specfunc/gsl_sf_bessel_y0/out_AFL$i -m none -t 5000 -- ${ROOT_DIR}/specfunc/gsl_sf_bessel_y0/bessely0 @@
fi
