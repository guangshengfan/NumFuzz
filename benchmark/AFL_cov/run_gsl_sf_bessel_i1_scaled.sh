...
if ! [ $(command llvm-config --version) = "6.0.1" ]; then
    ...
    ${ROOT_DIR}/../tool/AFL/build/bin/afl-clang-fast -Wl,-rpath=/usr/local/lib -lgsl -lgslcblas -lm i1scaled.c -o i1scaled
...
#    echo 0.981415806270390045363 > in/testcase2
    ...
    ${ROOT_DIR}/../tool/AFL/build/bin/afl-fuzz -i ${ROOT_DIR}/AFL_cov/gsl_sf_bessel_i1_scaled/in -o ${ROOT_DIR}/AFL_cov/gsl_sf_bessel_i1_scaled/out_covAFL$i -m none -t 5000 -- ${ROOT_DIR}/AFL_cov/gsl_sf_bessel_i1_scaled/i1scaled @@
fi
